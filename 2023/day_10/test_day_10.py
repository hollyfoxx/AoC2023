...
@pytest.mark.parametrize(
    ...
    [
        ...
        (day_10.PROBLEM_1_EXAMPLE_2_INPUT, day_10.PROBLEM_1_EXAMPLE__2_ANSWER), # ADD YOUR OWN TEST CASES HERE
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (day_10.PROBLEM_2_EXAMPLE_2_INPUT, day_10.PROBLEM_2_EXAMPLE__2_ANSWER),
    ],
)
